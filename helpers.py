...
def box_iou2(a, b):
    '''
    helper func to calculate ratio btw intersection and the union of
    two boxes a and b
...
def convert_to_pixel(box_yolo, img, crop_range):
    '''
    helper func to convert(scaled)  coordinates of a bounding box 
    to pixel coordinates. 
    
    eg. 
    (0.89361443264143803, 0.4880486045564924, 0.23544462956491041, 
    0.36866588651069609)
    ...
    # calcu left, top, width, and height of the bounding box
...
def convert_to_cv2bbox(bbox, img_dim = (1280, 720)):
    '''
    helper fucn for converting bbox to bbox_cv2
...
def draw_box_label(img, bbox_cv2, box_color=(0, 255, 255), show_label=True):
    '''
    helper func for drawing the bounding boxes and the labels
    bbox_cv2 = [left, top, right, bottom]
    '''
    ...
    if show_label:
        ...
        # o/p the labels that show the x and y coordinates of the bounding box center.
